...
#line 150 "http.tab.c" /* yacc.c:358  */
...
{
       0,    29,    29,    31,    31,    33,    33,    34,    34,    34,
      34,    34,    34,    34,    34,    36,    36,    36,    38,    38,
      38,    40,    40,    42,    42,    42,    44,    44,    44,    44,
      46,    46
};
#endif
...
{
  "$end", "error", "$undefined", "ENDL", "REQUESTLINE", "CONNECTION",
  "DATE", "TRANSFERENCODING", "ACCEPTCHARSET", "REFERER", "USERAGENT",
  "CONTENTLENGTH", "EXPIRES", "BODYSTRING", "END_OF_FILE", "$accept",
  "Request", "Request_Line", "Headers", "Header", "General_Header",
  "Request_Header", "Entity_Header", "Footer", "Message_Body", "ENDLS", YY_NULLPTR
};
#endif
...
{
      51,   -18,   -18,    16,    15,   -18,    30,   -18,   -18,   -18,
     -18,   -18,   -18,   -18,   -18,   -18,   -18,     0,    17,   -18,
     -18,   -18,    42,    21,   -18,    41,   -18,    18,   -18,   -18,
     -18,   -18,   -18,   -18,    43,    46,   -18,   -18,    -1,    43,
     -18,     1,   -18
};
...
{
       0,     3,     4,     0,     0,     1,     0,    14,    31,    15,
      16,    17,    18,    19,    20,    21,    22,     0,     0,    10,
      11,    12,     0,    31,    23,     0,     2,     0,     6,    13,
      30,     7,     8,     9,     0,    24,     5,    25,    29,     0,
      27,    28,    26
};
...
{
      27,     7,    30,    23,    30,     9,    10,    11,    12,    13,
      14,    15,    16,    40,    24,    42,     5,    38,     6,    29,
      28,    30,    41,     9,    10,    11,    12,    13,    14,    15,
      16,     7,    37,     8,    34,     9,    10,    11,    12,    13,
      14,    15,    16,    29,    36,    30,     8,     9,    10,    11,
      12,    13,    14,    15,    16,     1,    31,    32,    33,    39,
       0,    31,    32,    33,     2,    25
};

static const yytype_int8 yycheck[] =
{
      17,     1,     3,     3,     3,     5,     6,     7,     8,     9,
      10,    11,    12,    14,    14,    14,     0,    34,     3,     1,
       3,     3,    39,     5,     6,     7,     8,     9,    10,    11,
      12,     1,    14,     3,    13,     5,     6,     7,     8,     9,
      10,    11,    12,     1,     3,     3,     3,     5,     6,     7,
       8,     9,    10,    11,    12,     4,    22,    22,    22,    13,
      -1,    27,    27,    27,    13,    17
};
...
{
       0,     4,    13,    16,    17,     0,     3,     1,     3,     5,
       6,     7,     8,     9,    10,    11,    12,    18,    19,    20,
      21,    22,    25,     3,    14,    19,    23,    25,     3,     1,
       3,    20,    21,    22,    13,    24,     3,    14,    25,    13,
      14,    25,    14
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 2:
#line 29 "http.y" /* yacc.c:1646  */
    { cout << "FILE CHECK COMPLETE!\n"; }
#line 1255 "http.tab.c" /* yacc.c:1646  */
    break;

  case 4:
#line 31 "http.y" /* yacc.c:1646  */
    { yyerror("Bad Request line."); yyerrok; yyclearin; body_length = 0; req_error = 1; }
#line 1261 "http.tab.c" /* yacc.c:1646  */
    break;

  case 7:
#line 34 "http.y" /* yacc.c:1646  */
    { yyerror("Empty line."); cout << "General Header found.\n"; yyerrok; yyclearin; }
#line 1267 "http.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 34 "http.y" /* yacc.c:1646  */
    { yyerror("Empty line."); cout << "Request Header found.\n"; yyerrok; yyclearin; }
#line 1273 "http.tab.c" /* yacc.c:1646  */
    break;

  case 9:
#line 34 "http.y" /* yacc.c:1646  */
    { yyerror("Empty line."); cout << "Entity Header found.\n"; yyerrok; yyclearin; }
#line 1279 "http.tab.c" /* yacc.c:1646  */
    break;

  case 10:
#line 34 "http.y" /* yacc.c:1646  */
    { cout << "General Header found.\n"; }
#line 1285 "http.tab.c" /* yacc.c:1646  */
    break;

  case 11:
#line 34 "http.y" /* yacc.c:1646  */
    { cout << "Request Header found.\n"; }
#line 1291 "http.tab.c" /* yacc.c:1646  */
    break;

  case 12:
#line 34 "http.y" /* yacc.c:1646  */
    { cout << "Entity Header found.\n"; }
#line 1297 "http.tab.c" /* yacc.c:1646  */
    break;

  case 13:
#line 34 "http.y" /* yacc.c:1646  */
    { yyerror("Empty line."); yyerror("Bad Header."); yyerrok; yyclearin; body_length = 0; }
#line 1303 "http.tab.c" /* yacc.c:1646  */
    break;

  case 14:
#line 34 "http.y" /* yacc.c:1646  */
    { yyerror("Bad Header."); yyerrok; yyclearin; body_length = 0;}
#line 1309 "http.tab.c" /* yacc.c:1646  */
    break;

  case 23:
#line 42 "http.y" /* yacc.c:1646  */
    { if ( strcmp(method_check, "POST") == 0 ) { yyerror("No body found."); if (content_header_check == 0) { yyerror("No Content Header found."); yyerrok; yyclearin; } else { if (body_length == content_length) cout << "Content length given matches.\n"; else { yyerror("Bad content length."); yyerrok; yyclearin; } } } else cout << "No message body found.\n"; unhandled_error = 0; }
#line 1315 "http.tab.c" /* yacc.c:1646  */
    break;
...
#line 1321 "http.tab.c" /* yacc.c:1646  */
  ...
  case 26:
#line 44 "http.y" /* yacc.c:1646  */
    { if ( strcmp(method_check, "POST") == 0 ) { cout << "Found message body while method was POST.\n"; if (content_header_check == 0) { yyerror("No Content Header found."); yyerrok; yyclearin; } else { if (body_length == content_length) cout << "Content length given matches.\n"; else { yyerror("Bad content length."); yyerrok; yyclearin; } } } else cout << "Found message body.\n"; unhandled_error = 0; }
#line 1327 "http.tab.c" /* yacc.c:1646  */
    break;

  case 27:
#line 44 "http.y" /* yacc.c:1646  */
    { if ( strcmp(method_check, "POST") == 0 ) { cout << "Found message body while method was POST.\n"; if (content_header_check == 0) { yyerror("No Content Header found."); yyerrok; yyclearin; } else { if (body_length == content_length) cout << "Content length given matches.\n"; else { yyerror("Bad content length."); yyerrok; yyclearin; } } } else cout << "Found message body.\n"; unhandled_error = 0; }
#line 1333 "http.tab.c" /* yacc.c:1646  */
    break;

  case 30:
#line 46 "http.y" /* yacc.c:1646  */
    { ++empty_lines; }
#line 1339 "http.tab.c" /* yacc.c:1646  */
    break;

  case 31:
#line 46 "http.y" /* yacc.c:1646  */
    { ++empty_lines; }
#line 1345 "http.tab.c" /* yacc.c:1646  */
    break;


#line 1349 "http.tab.c" /* yacc.c:1646  */
      default: break;
    }
